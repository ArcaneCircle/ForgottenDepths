...
import { change_track, heal_sound, zzfx_play } from "../zzfx";
import { ceil, floor, math, max, random_int, safe_add, safe_subtract } from "../math/math";
